...
const server = require("../../../server"); // Assuming server.js is your app entry point
...
describe("GET /api/tailors/collection/:name - Integration Test", function () {
  ...
  it("should return tailors for the given collection with status 200", async function () {
    const response = await request(server).get(
      "/api/tailors/collection/Dresses"
    );
